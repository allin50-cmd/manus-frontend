...
const server = app.listen(PORT, () => {
  ...
  console.log('  GET    /api/health  |  GET /health');
  console.log('  POST   /api/stripe/checkout');
  console.log('  GET    /api/protection-status');
  ...
  console.log('  POST   /api/lunar/intake');
  console.log('  GET    /api/lunar/intake/:id');
  console.log('  POST   /api/ultai/analyze');
  console.log('  GET    /api/ultai/analyses');
  console.log('  GET    /api/ultai/analyses/:id');
  console.log('  POST   /api/stripe/webhook  (raw body)');
  console.log('');
  console.log('tRPC: /api/trpc/* (auth, cases, hearings, documents, allocations, diary, dashboard, lunar)');
});
