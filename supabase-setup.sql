-- ============================================================
-- FineGuard / ClerkOS — Supabase schema setup
-- Run this once in the Supabase SQL editor:
--   https://supabase.com/dashboard → your project → SQL Editor
-- ============================================================

-- ─── Brand Suite tables (brand-suite Drizzle schema) ─────────────────────────
...
-- ─── ClerkOS tables (tRPC server Drizzle schema) ──────────────────────────────
...
-- ─── SheetOps / Prisma tables ─────────────────────────────────────────────────
-- These are managed by Prisma. Run the following from your local machine instead:
--   npx prisma db push
