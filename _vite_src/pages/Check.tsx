...
export default function Check() {
  ...
  const { set: setOnboardingState } = useOnboardingState();
  ...
  const handleContinue = (company: CompanyResult) => {
    setOnboardingState({
      selectedCompany: {
        ...
        <>
              ...
              <div className="max-w-3xl mx-auto">
                ...
                <div className="space-y-4">
                  {results.map((company) => (
                    <div
                      key={company.number}
                      className="card-elevated p-6 rounded-lg bg-white dark:bg-slate-800 border-2 border-gray-200 dark:border-slate-700 cursor-pointer hover:border-blue-500 transition"
            ...
            <section className="px-4 py-12">
              <div className="max-w-3xl mx-auto text-center">
                <p className="text-gray-600 dark:text-gray-400">
                  No companies found matching "{searchQuery}". Try searching with a different name or number.
                </p>
              </div>
            </section>
          )}
          ...
          {!searchQuery && results.length === 0 && (
            <section className="px-4 py-12 bg-gray-50 dark:bg-slate-900">
              <div className="max-w-3xl mx-auto">
                <h2 className="text-2xl font-bold mb-8">How to monitor companies</h2>
        ...
        <section className="px-4 py-12">
          <div className="max-w-2xl mx-auto">
            ...
            <ActivationPanel
              ...
              onContinue={() => handleContinue(selectedCompany)}
            />
          </div>
        </section>
      )}
