...
export default function BuilderBigJobsAccuracyPage() {
      ...
      <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center px-4 text-white">
        <div className="w-full max-w-md text-center">
          ...
          <p className="text-slate-400 mb-4">
            We'll be in touch when we have building opportunities that match what you're looking for.
          </p>
          <p className="text-slate-500 text-sm">
            Questions? Email{' '}
            <a href="mailto:leads@builderbigj obs.co.uk" className="text-orange-400 hover:underline">
              leads@builderbigj obs.co.uk
            </a>
          </p>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      ...
      {/* ── Header ── */}
      <header className="px-6 py-5 flex items-center justify-between max-w-3xl mx-auto border-b border-slate-800">
        ...
        <span className="text-xs text-slate-500">Planning-approved building leads</span>
      </header>

      {/* ── Hero ── */}
      <section className="px-6 pt-12 pb-8 max-w-3xl mx-auto text-center">
        <div className="inline-block bg-orange-500/20 text-orange-400 text-xs font-semibold px-3 py-1 rounded-full mb-5 uppercase tracking-wide">
          For serious contractors
        </div>
        <h1 className="text-3xl sm:text-4xl font-extrabold leading-tight mb-4 tracking-tight">
          Big building jobs,<br className="hidden sm:block" /> not time-wasters.
        </h1>
      ...
      <section className="px-6 pb-10 max-w-3xl mx-auto">
        <div className="grid grid-cols-3 sm:grid-cols-6 gap-2">
          {['Extensions', 'Loft conversions', 'Renovations', 'New builds', 'Refurbishments', 'Commercial'].map((t) => (
            <div key={t} className="bg-slate-800 rounded-lg px-3 py-2 text-center text-xs text-slate-300 font-medium">
              {t}
            </div>
          ))}
        </div>
      ...
      <div className="px-6 pb-16 max-w-3xl mx-auto">
        <div className="mb-6">
          <h2 className="text-xl font-bold mb-1">Register for building leads</h2>
          <p className="text-slate-400 text-sm">Tell us what you're looking for. We match, then route.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="bg-slate-800 rounded-2xl p-5 space-y-4">
            <h3 className="text-xs font-semibold text-slate-400 uppercase tracking-wide">Your details</h3>
          ...
          {/* Service area */}
          <div className="bg-slate-800 rounded-2xl p-5 space-y-4">
            <h3 className="text-xs font-semibold text-slate-400 uppercase tracking-wide">Service area</h3>
            <div className="grid sm:grid-cols-2 gap-4">
          ...
          {/* Job types */}
          <div className="bg-slate-800 rounded-2xl p-5 space-y-4">
            <h3 className="text-xs font-semibold text-slate-400 uppercase tracking-wide">Job types wanted</h3>
              ...
              {JOB_TYPES.map((jt) => (
                ...
                >
                  <input
                    ...
                    className="hidden"
                  />
                  <span className="text-sm font-medium leading-tight">{jt.label}</span>
                </label>
              ))}
            </div>
          </div>
          ...
          {/* Job size */}
          <div className="bg-slate-800 rounded-2xl p-5 space-y-4">
            <h3 className="text-xs font-semibold text-slate-400 uppercase tracking-wide">Minimum job size</h3>
          ...
          {/* Contact method */}
          <div className="bg-slate-800 rounded-2xl p-5 space-y-4">
            <h3 className="text-xs font-semibold text-slate-400 uppercase tracking-wide">Preferred contact method</h3>
          ...
          <div className="bg-slate-800 rounded-2xl p-5 space-y-3">
            <h3 className="text-xs font-semibold text-slate-400 uppercase tracking-wide">Anything else?</h3>
            <textarea
              rows={3}
              value={form.notes}
          ...
          {error && (
            <p className="text-red-400 text-sm bg-red-950/40 border border-red-900/30 rounded-lg px-4 py-3">
              {error}
            </p>
          )}
          ...
          >
            {busy ? 'Registering…' : 'Get Builder Leads →'}
          </button>

          <p className="text-center text-slate-500 text-xs">
            No commitment. We match leads to your preferences before contacting you.
          </p>
        </form>
      </div>
    </div>
