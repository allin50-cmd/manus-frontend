  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Accuracy Developments</h1>
          <p className="text-slate-500 text-sm">Planning leads · Projects · Site visits</p>
        </div>
      </div>

      {/* Links */}
      <div className="space-y-2">
        <WorkspaceLink href="/intake/accuracy" label="Builder Big Jobs Intake" desc="Submit planning-approved leads" external />
        <WorkspaceLink href="/os/leads/builder-big-jobs" label="Leads" desc="All leads in the pipeline" />
      </div>
    </div>
  )
}
