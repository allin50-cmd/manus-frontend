...
export default function UltAiPage() {
    ...
    <div className="min-h-screen bg-white dark:bg-slate-950">
      ...
      <header className="border-b bg-white dark:bg-slate-900">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">UltAi Call Intake</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-1">AI-powered voice reception and intake management</p>
        </div>
      </header>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-8">
          {[
            ...
            <div key={idx} className="p-4 rounded-lg bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700">
        ...
        {activeTab === 'live-call' && (
          <div className="grid lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2">
              <div className="p-8 rounded-lg bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700">
                ...
                <div className="flex gap-3 mt-8">
                  ...
                  >
                    {isRecording ? '🔴' : '⭕'} {isRecording ? 'Recording' : 'Paused'}
                  </button>
                </div>
              </div>
            </div>
        ...
        {activeTab === 'analytics' && (
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div key={idx} className="p-6 rounded-lg bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700">
