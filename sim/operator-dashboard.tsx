  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white p-6 font-mono">
      ...
      <section className="grid grid-cols-5 gap-3 mb-6">
        {(["GREEN", "AMBER", "RED", "BLACK", "RECOVER"] as FailureState[]).map((state) => {
...
function NodeCard({
  ...
  return (
    <div className={`border border-white/10 rounded-xl p-4 ${node.state === "BLACK" ? "bg-gray-900" : "bg-gray-900/30"}`}>
