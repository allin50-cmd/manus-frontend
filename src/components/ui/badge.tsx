...
export type BadgeVariant = 'default' | 'outline' | 'purple' | 'cyan' | 'gold' | 'green' | 'red' | 'orange' | 'gray' | 'destructive' | 'secondary';
...
const variantClasses: Record<BadgeVariant, string> = {
  ...
  outline:     'bg-transparent text-gray-300 border-white/30',
